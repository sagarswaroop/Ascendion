...
define([
    ...
    function onRequest(context) {
        if (context.request.method === 'GET') {
            ...
            if (tranDate) currentdate.defaultValue = tranDate;
            ...
            if (entity) employeeField.defaultValue = entity;
            ...
            if (memo) memoField.defaultValue = memo;
            ...
            if (dueDate) dueDateField.defaultValue = dueDate;

            let subsidiaryField = form.addField({
                id: "custpage_subsidiary",
                container: "custpage_primary_info",
                type: serverWidget.FieldType.INLINE,
                source: "subsidiary",
                label: "Subsidiary",
            });
            ...
            let subsidiary = requisitionRecord.getValue({
                fieldId: 'subsidiary'
            })

            if (subsidiary > 0) subsidiaryField.defaultValue = subsidiary;
