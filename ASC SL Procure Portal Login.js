 ...
 */
define(["N/ui/serverWidget", "N/http", "N/url"], (serverWidget, http, url) => {
    ...
    const executeGet = (scriptContext) => {
        try {
            ...
            strName += `$.ajax({
                url: 'https://7315200-sb1.extforms.netsuite.com/app/site/hosting/scriptlet.nl?script=2052&deploy=1&compid=7315200_SB1&ns-at=AAEJ7tMQicBz4oW6_Yfds4MuwADPUN_nCZWRMpdDm8ACPc2RK1I',
                method: 'POST',
                data: {email: userName, pass: password, type: "login"},
                success: function(response) {
                    let responseObj = JSON.parse(response);
                    console.log("responseObj,responseObj);
                    let value = responseObj.success;
                    if(value == true){
                    // document.location.href = "https://7315200-sb2.app.netsuite.com/app/site/hosting/scriptlet.nl?script=1329&deploy=1&compid=7315200_SB2&ns-at=AAEJ7tMQzQTw5iZlWUvBS8J3k6g1Lu94UsdqI84cr47jY_-g3tM&employeeid="+responseObj.id+""
                    }else{
            ...
            // strName += '            document.location.href="https://forms.na1.netsuite.com/app/site/hosting/scriptlet.nl?script=71&deploy=1&compid=TSTDRV970996&h=cd07f4d82cab35f8f01e&userName="+userName+"&password="+encryptedPass+""';
            strName += '        }';
            strName += '    });';
            strName += '});';
            strName += '</script>';
