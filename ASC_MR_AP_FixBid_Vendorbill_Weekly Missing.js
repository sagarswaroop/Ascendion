                            ...
                            trackTimeObj.run().each(function(result){
                             ...
                             if(vendBillID){
                                ...
                                // else{
                                     ...
                                     if(billId){
                                            log.debug("bill is already present")
                                     }
                                     else{
