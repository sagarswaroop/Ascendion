                    ...
                    if (key != 'invoiceTotal') {
                        ...
                        // for (var tt = 0; tt < trackTimeIDs.length; tt++) {
                            ...
                            // if (linenum > -1) {
                                ...
                                var currentSublist = invoiceObj.selectNewLine({ sublistId: 'time'});
                                currentSublist.setCurrentSublistValue({ sublistId: 'time', fieldId: 'apply', value: true });
                                currentSublist.setCurrentSublistValue({ sublistId: 'time', fieldId: 'rate', value: timeRate[tt] });
