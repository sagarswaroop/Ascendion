...
define(["N/search", "N/record", "N/runtime", "N/file", "N/format", "SuiteScripts/Projects/Library/Project Library.js"], (search, record, runtime, file, format, lib) => {
    ...
    const createRecords = (projectJSON, taskId) => {
        ...
        try 
        {
            ...
            if(projectId) 
            {
                ...
                {
                    let empInternalId = getEmployeeInternalId((projectResourceArray[g].resource));
                    ...
                    if(resourceId)
                    {
                        ...
                        if(vendor_id)
                        {
                            ...
                            var apDedRecId = createAPDedRec(apDedObj, intRecordId);
				...
				let updatedProjectId = updateProject(projectId, projectEndDate, newEndDate, intRecordId);
    ...
    const createAPDedRec = (apDedObj, intRecordId) =>{
        try 
        {
            let recordIds = [];
            if(apDedObj.vendor)
	...
	const updateProject = (projectId, projectEndDate, newEndDate, intRecordId) =>{
        try
        {
