            ...
            try {
                ...
                if (vendBillID) {
                    ...
                    var customrecord_asc_trnsctn_crtn_rprt_arapSearchObj = search.create({
                        ...
                        filters:
                            [
                                ["custrecord_asc_period_strt_date", "on", periodStart],
                                "AND",
                                ["custrecord_asc_period_end_date", "on", periodEnd],
                                "AND",
                    ...
                    log.debug("searching the custom record and attaching the bill")
                    var customrecord_asc_invbill_scheduleSearchObj = search.create({
                        ...
                        filters:
                            [
                                ...
                                "AND",
                                ["custrecord_asc_schrec_startdate", "on", periodStart],
                                "AND",
                                ["custrecord_asc_schrec_enddate", "on", periodEnd],
                                "AND",
                                ["custrecord_asc_schrec_employee", "anyof", employee]
                    ...
                    customrecord_asc_invbill_scheduleSearchObj.run().each(function (result) {
                        ...
                        var scheId = record.submitFields({
                            ...
                            id: result.id,
                            values: {
                                "custrecord_asc_schrec_vendorbill": vendBillID
                            },
                            options: {
