...
DD-MM-YYYY        Employee Name         Client Name           One line description
 02/21/2024       Ataullah              Satish Jha            Initilaly script was running daily and stamped the date period based on weeknding day of the project
                                                              but script will stamp the date period for only sunday weekending from now for evry project and process will run only sunday to optimize the functionality                
 */
    ...
    function (search, record, runtime,query,format,lib) {
        function getInputData() {
            try {
                ...
                if(deploymentID == 'customdeploy_asc_mr_ap_fixbid_vb_weekly'){
                    ...
                    // var queryStr = "SELECT resVend.custrecord_clb_subcon_vb_date,resVend.custrecord_clb_originalstartdate,resVend.custrecord_clb_originalenddate,resVend.custrecord_clb_subcon_terms,resVend.custrecord_clb_newapbased,resVend.custrecord_clb_paymode,resVend.custrecord_clb_vendor,resVend.custrecord_clb_subconresource,resVend.custrecord_clb_workflowid, job.ID, job.custentity_clb_bilcycle, job.custentity_clb_projecttypeforinvoicing,resVend.id, resVend.custrecord_clb_msng_vb_dates,resVend.custrecord_asc_subcon_paystatus,resAlloc.startdate,resAlloc.endDate FROM job AS job INNER JOIN customrecord_clb_subconvendor AS resVend ON job.ID = resVend.custrecord_clb_subcon_project INNER JOIN resourceAllocation AS resAlloc ON job.ID = resAlloc.project  WHERE (job.custentity_clb_projecttypeforinvoicing IN (5)) AND (resVend.custrecord_clb_subconresource IS NOT NULL) AND (resAlloc.startdate <= '" + nstoDt + "') AND  (resAlloc.endDate >= '" + nsfromDt + "') AND (resVend.custrecord_clb_newapbased IN (4)) AND resVend.custrecord_clb_workflowid = resAlloc.custevent_clb_prjct_workl_tsk_id AND (resVend.custrecord_clb_subcon_vb_date < '" + nstoDt + "' OR resVend.custrecord_clb_subcon_vb_date IS NULL)  AND (resVend.custrecord_clb_vendor NOT IN (67134,67145,67150,67151,67901))" // (job.custentity_clb_lastday = '" +day+ "' ) 
                     var queryStr = "SELECT resVend.custrecord_clb_subcon_vb_date,resVend.custrecord_clb_originalstartdate,resVend.custrecord_clb_originalenddate,resVend.custrecord_clb_subcon_terms,resVend.custrecord_clb_newapbased,resVend.custrecord_clb_paymode,resVend.custrecord_clb_vendor,resVend.custrecord_clb_subconresource,resVend.custrecord_clb_workflowid, job.ID, job.custentity_clb_bilcycle, job.custentity_clb_projecttypeforinvoicing,resVend.id, resVend.custrecord_clb_msng_vb_dates,resVend.custrecord_asc_subcon_paystatus,resAlloc.startdate,resAlloc.endDate FROM job AS job INNER JOIN customrecord_clb_subconvendor AS resVend ON job.ID = resVend.custrecord_clb_subcon_project INNER JOIN resourceAllocation AS resAlloc ON job.ID = resAlloc.project  WHERE (job.custentity_clb_projecttypeforinvoicing IN (5)) AND (resVend.custrecord_clb_subconresource IS NOT NULL) AND (resAlloc.startdate <= '" + nstoDt + "') AND  (resAlloc.endDate >= '" + nsfromDt + "') AND (resVend.custrecord_clb_originalstartdate <= '" + nstoDt + "') AND  (resVend.custrecord_clb_originalenddate >= '" + nsfromDt + "') AND (resVend.custrecord_clb_newapbased IN (4)) AND resVend.custrecord_clb_workflowid = resAlloc.custevent_clb_prjct_workl_tsk_id AND (resVend.custrecord_clb_subcon_vb_date < '" + nstoDt + "' OR resVend.custrecord_clb_subcon_vb_date IS NULL)  AND (resVend.custrecord_clb_vendor NOT IN (67134,67145,67150,67151,67901))" //  new query whcih check the resource date as well 
                    //var queryStr = "SELECT resVend.custrecord_clb_subcon_vb_date,resVend.custrecord_clb_originalstartdate,resVend.custrecord_clb_originalenddate,resVend.custrecord_clb_subcon_terms,resVend.custrecord_clb_newapbased,resVend.custrecord_clb_paymode,resVend.custrecord_clb_vendor,resVend.custrecord_clb_subconresource,resVend.custrecord_clb_workflowid, job.ID, job.custentity_clb_bilcycle, job.custentity_clb_projecttypeforinvoicing,resVend.id, resVend.custrecord_clb_msng_vb_dates,resVend.custrecord_asc_subcon_paystatus,resAlloc.startdate,resAlloc.endDate FROM job AS job INNER JOIN customrecord_clb_subconvendor AS resVend ON job.ID = resVend.custrecord_clb_subcon_project INNER JOIN resourceAllocation AS resAlloc ON job.ID = resAlloc.project  WHERE (job.custentity_clb_projecttypeforinvoicing IN (5)) AND (resVend.custrecord_clb_subconresource IS NOT NULL) AND (resVend.custrecord_clb_originalstartdate <= '" + nstoDt + "') AND  (resVend.custrecord_clb_originalenddate >= '" + nsfromDt + "') AND (resVend.custrecord_clb_newapbased IN (4)) AND resVend.custrecord_clb_workflowid = resAlloc.custevent_clb_prjct_workl_tsk_id AND (resVend.custrecord_clb_subcon_vb_date < '" + nstoDt + "' OR resVend.custrecord_clb_subcon_vb_date IS NULL) AND (job.custentity_clb_lastday = '" +day+ "' ) AND (resVend.custrecord_clb_vendor NOT IN (67134,67145,67150,67151,67901))"
                    //var queryStr = "SELECT resVend.custrecord_clb_subcon_vb_date,resVend.custrecord_clb_originalstartdate,resVend.custrecord_clb_originalenddate,resVend.custrecord_clb_subcon_terms,resVend.custrecord_clb_newapbased,resVend.custrecord_clb_paymode,resVend.custrecord_clb_vendor,resVend.custrecord_clb_subconresource, job.ID, job.custentity_clb_bilcycle, job.custentity_clb_projecttypeforinvoicing,resVend.id, resVend.custrecord_clb_msng_vb_dates,resVend.custrecord_asc_subcon_paystatus FROM customrecord_clb_subconvendor AS resVend LEFT JOIN job ON (resVend.custrecord_clb_subcon_project = job.ID) WHERE (job.custentity_clb_projecttypeforinvoicing IN (5)) AND (resVend.custrecord_clb_subconresource IS NOT NULL) AND (resVend.custrecord_clb_originalstartdate <= '"+nstoDt+"') AND  (resVend.custrecord_clb_originalenddate >= '"+nsfromDt+"') AND (resVend.custrecord_clb_newapbased IN (4)) AND (resVend.custrecord_clb_subcon_vb_date < '" + nstoDt+ "' OR resVend.custrecord_clb_subcon_vb_date IS NULL) AND (job.custentity_clb_lastday = '"+ day+"' ) AND (job.custentity_clb_lastday = '7' ) AND (resVend.custrecord_clb_vendor NOT IN (26187,26824,26607,26509,26508,63269))";
        ...
        function reduce(context) {
            try {
                ...
                var deploymentID  = scriptObj.deploymentId;
                var key = context.key;
                var resourceDetails = context.values[0]
                log.debug("Reduce Stage: projectDetails key: "+key , JSON.stringify(resourceDetails));
                resourceDetails = JSON.parse(context.values[0]);
        ...
        function createVendorBill(vendorBillDetails,projectID,billingStartDate,billingEndDate,vendorID,term,paymentMode,employee,payStatus,apbased,projSubsidiary){
            try{
                ...
                log.debug("Error at Stage : createVendorBill function",e)
